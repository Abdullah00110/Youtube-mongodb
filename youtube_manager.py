...
client = MongoClient(
    "mongodb+srv://youtubepy:youtubepy@cluster0.twzmfju.mongodb.net/")
...
def main():
    while True:
        ...
        if choice == '1':
            ...
            name = input("Enter the add video name: ")
            time = input("Enter the add video time: ")
            add_video(name, time)
